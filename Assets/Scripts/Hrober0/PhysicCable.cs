...
/**
 * 
 * Code adapted from: https://github.com/Hrober0/Cable-physics
 * 
 */
public class PhysicCable : MonoBehaviour
{
    ...
    private SwitchboardPlug startConnector;
    private SwitchboardPlug endConnector;
    ...
    private void Start()
    {
        startConnector = start.GetComponent<SwitchboardPlug>();
        endConnector = end.GetComponent<SwitchboardPlug>();
    ...
    public SwitchboardPlug StartConnector => startConnector;
    public SwitchboardPlug EndConnector => endConnector;
